...
public class ContractPrint{
	...
	public void print(com.wl.jx.vo.Contract contract,String path, HttpServletResponse response) throws Exception{
		//相同厂家的信息一起打印
		...
		String stars = "";
		for(int j=0;j<Integer.valueOf(contract.getImportNum());j++){		//重要程度
			stars += "★";
		}
